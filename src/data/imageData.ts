...
export const images: ImageAsset[] = [
  ...
  // ── Inleiding ──────────────────────────────────────────
  img("image21.jpg", "inleiding", "Een labyrint van wegen", "Cover / route visual", "", "The Labyrinth (2018). Acrylic on canvas (80×60cm)"),
  img("image51.jpg", "inleiding", "Een labyrint van wegen", "", "", "Miniature painting from the book layout"),
  img("image92.jpg", "inleiding", "Een labyrint van wegen", "", "", "Werehpai Petroglyph (2018). Acrylic on canvas (90×70cm)"),
  ...
  img("image45.jpg", "hoofdstuk-1", "Werehpai Petroglyph", "Werehpai Petroglyph (2018). Acrylic on canvas (90×70cm)", "", "1977 — Winston's graphic advertising designs for the tobacco industry"),
  img("image109.jpg", "hoofdstuk-1", "Werehpai Petroglyph", "", "", "Maluana (2021). Natural pigments on wood"),
  img("image33.jpg", "hoofdstuk-1", "Werehpai Petroglyph", "Zoo humain: Les indigènes des Caraïbes", "Zoo humain : Les indigènes des Caraïbes au jardin d", "Zoo humain: Les indigènes des Caraïbes au Jardin d'Acclimatation, Paris (1892)"),
  img("image26.png", "hoofdstuk-1", "Werehpai Petroglyph", "", "", "Pencil drawing by Johan van der Bok (2015)"),
  img("image69.jpg", "hoofdstuk-1", "Werehpai Petroglyph", "", "", "Hope for the Future (2005). Acrylic on canvas (70×100cm)"),
  ...
  img("image52.jpg", "hoofdstuk-1", "Werehpai Petroglyph", "", "", "Sunflower (2019). Acrylic on canvas (90×70cm)"),
  ...
  img("image86.jpg", "hoofdstuk-1", "Werehpai Petroglyph", "", "", "Powersigns (2015). Acrylic on wood (75×23cm)"),
  ...
  img("image117.jpg", "hoofdstuk-1", "Asamiya / Mother and Child", "Mother and Child, watercolour on paper", "", "Sambura (2007). Acrylic on canvas (114×74cm)"),
  ...
  img("image32.jpg", "hoofdstuk-1", "Asamiya / Mother and Child", "", "", "Icons (2005). Acrylic on canvas (44×65cm)"),
  img("image130.jpg", "hoofdstuk-1", "Asamiya / Mother and Child", "", "", "Artwork from the Kalihna culture section"),
  img("image58.jpg", "hoofdstuk-1", "Spirit of the Tides", "Spirit of the Tides (2018). Acrylic on canvas (110×70cm)", "", "The Seven Sisters (2017). Acrylic on wood (215×37.5cm)"),
  ...
  img("image112.png", "hoofdstuk-1", "Sambura en Karawasi", "", "", "Dancing Amazonas (1998). Acrylic on board (44×36cm)"),
  ...
  img("image59.jpg", "hoofdstuk-1", "Sambura en Karawasi", "", "", "Dancing Couples (2005). Acrylic on canvas (82×52cm)"),
  ...
  img("image129.jpg", "hoofdstuk-2", "Kinderjaren tussen werelden", "", "", "Spirit of the Tides (2018). Acrylic on canvas (110×70cm)"),
  img("image6.jpg", "hoofdstuk-2", "Tante Es", "Elselyn Fa-Si-Oen en Winston", "", "Elselyn Fa-Si-Oen and Winston — foster mother and son"),
  img("image13.jpg", "hoofdstuk-2", "Tante Es", "", "", "The Flute Player (2001). Acrylic on canvas (95×65cm)"),
  ...
  img("image9.png", "hoofdstuk-3", "Terug in Suriname", "", "", "Pïyai and Helpers (2017). Acrylic on canvas"),
  img("image103.jpg", "hoofdstuk-3", "Terug in Suriname", "", "", "The Flute Player (2001). Acrylic on canvas (95×65cm)"),
  ...
  img("image20.jpg", "hoofdstuk-3", "Terug in Suriname", "", "", "Matrimonium (2011). Acrylic on paper (25×20cm)"),
  ...
  img("image99.jpg", "hoofdstuk-5", "Zelfstandig ondernemer", "", "", "Family (1992). Pastel on paper (60×45cm)"),
  ...
  img("image115.jpg", "hoofdstuk-5", "Zelfstandig ondernemer", "", "", "Wodi. Hijaro (1995). Acrylic on canvas (20×20cm)"),
  ...
  img("image101.jpg", "hoofdstuk-5", "Paranakïrï", "Paranakïrï — de geesten uit de zee", "", "Paranakïrï — de geesten uit de zee (Spirits from the Sea)"),
  ...
  img("image4.jpg", "hoofdstuk-5", "Herdenking 1492–1992", "Kuluwayak poster/herdenkingszegel (1992)", "", "Matrimonium (2011). Acrylic on paper (25×20cm)"),
  ...
  img("image42.jpg", "hoofdstuk-5", "Kunst als gemeenschapsdienst", "", "", "Spirits of the Dance (2005). Acrylic on canvas (100×70cm)"),
  img("image67.jpg", "hoofdstuk-5", "Kunst als gemeenschapsdienst", "", "", "Graphic design — community arts project"),
  img("image44.jpg", "hoofdstuk-5", "Kunst als gemeenschapsdienst", "", "", "The Guardian (1998). Acrylic on paper (40×68cm)"),
  img("image54.jpg", "hoofdstuk-5", "Verhalen als grondstof", "Nature Eyes. Acrylic on paper (15×15cm)", "", "Nature Eyes. Acrylic on paper (15×15cm)"),
  img("image105.jpg", "hoofdstuk-5", "Verhalen als grondstof", "", "", "His Masterpiece (2013). Acrylic on canvas (100×120cm)"),
  img("image95.jpg", "hoofdstuk-5", "Levend erfgoed", "", "", "Pïyai Maraka (2011). Acrylic on board (45×52cm)"),
  img("image14.jpg", "hoofdstuk-5", "Levend erfgoed", "", "", "Kunstinstallatie met rouw-elementen van Kurt Nahar (2023)"),
  img("image87.jpg", "hoofdstuk-5", "Levend erfgoed", "Spirit of the Waves (2018). Acrylic on canvas (80×60)", "", "Powersigns (2015). Acrylic on wood (75×23cm)"),
  img("image70.jpg", "hoofdstuk-5", "Levend erfgoed", "", "", "Spirit of the Waves (2018). Acrylic on canvas (80×60cm)"),
  ...
  img("image116.jpg", "hoofdstuk-5", "Rood — levenskracht", "Rhythm of Dancers", "", "Maiden (2001). Mixed media on paper on canvas (21×20cm)"),
  img("image104.jpg", "hoofdstuk-5", "Rood — levenskracht", "", "", "Nature Eyes. Acrylic on paper (15×15cm)"),
  img("image43.jpg", "hoofdstuk-5", "Rood — levenskracht", "", "", "Artwork from the Red — Life Force section"),
  img("image113.jpg", "hoofdstuk-5", "Spirits of the Dance", "Spirits of the Dance (2005). Acrylic on canvas (100×70cm)", "", "Paramaribo, Palmentuin 1953 — portrait photograph"),
  ...
  img("image40.jpg", "hoofdstuk-6", "Op leven en dood", "", "", "Transformations (2010). Acrylic on canvas (95×66cm)"),
  ...
  img("image66.jpg", "hoofdstuk-6", "Op leven en dood", "", "", "Nurturing Nature (2018). Acrylic on canvas (67×97.5cm)"),
